export default class wheader extends HTMLElement {
  ...
  #initEvents() {
    ...
    window.addEventListener('scroll', e => {
      container.classList.toggle('sticky', (window.scrollY > (container.offsetTop + container.offsetHeight)));
    });
    ...
    container.delegateEventListener('slot', 'slotchange', function(){
      ...
      if (this.getAttribute('name') == 'right')
      {
        ...
        {
          container.removeAttribute('slot-right');
        }
        else
        {
          container.setAttribute('slot-right', 'slotted');
        };
      };
