...
CREATE TABLE `console_account`  (
  ...
  `role` int NULL DEFAULT 0 COMMENT '{\"format\":\"int\"}',
  ...
  `last_time` datetime NULL DEFAULT NULL COMMENT '{\"mode\":\"manual\",\"required\":false,\"format\":\"datetime\"}',
  `last_date` int NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\",\"required\":false,\"format\":\"int\"}',
  `last_error_count` int NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\",\"required\":false,\"format\":\"int\"}',
  `time` datetime NULL DEFAULT NULL COMMENT '{\"format\":\"datetime\"}',
  `locked` tinyint NULL DEFAULT 0 COMMENT '{\"format\":\"int\"}',
  `deleted` tinyint NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\",\"required\":false,\"format\":\"int\"}',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `console_cloud-detect`  (
  ...
  `kernel_detected_at` bigint NULL DEFAULT 0,
  `package_detected_at` bigint NULL DEFAULT 0,
  `has_new_version_for_kernel` int NULL DEFAULT 0,
  `has_new_version_for_package` int NULL DEFAULT 0,
...
CREATE TABLE `console_cloud-migrate`  (
  ...
  `target_version` int NULL DEFAULT 0,
...
CREATE TABLE `console_log`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '{\"manual\":\"true\"}',
  `genre` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `deleted` tinyint NULL DEFAULT 0 COMMENT '{\"manual\":\"true\"}',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `deleted`(`deleted`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `news`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '{\"mode\":\"auto\"}',
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '{\"type\":\"text\"}',
  `category` int NULL DEFAULT 0 COMMENT '{\"type\":\"select\",\"format\":\"int\",\"locked\":true}',
...
CREATE TABLE `universal_captcha`  (
  ...
  `deleted` tinyint NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\"}',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `deleted`(`deleted`) USING BTREE,
...
CREATE TABLE `universal_category`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '{\"mode\":\"auto\"}',
  `father_id` int NULL DEFAULT 0 COMMENT '{\"required\":false,\"format\":\"int\"}',
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `order` int NULL DEFAULT 0 COMMENT '{\"required\":false,\"format\":\"int\"}',
  `time` datetime NULL DEFAULT NULL COMMENT '{\"format\":\"datetime\"}',
  `lang` tinyint NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\",\"required\":false,\"format\":\"int\"}',
  `published` tinyint NULL DEFAULT 0 COMMENT '{\"required\":false,\"format\":\"int\"}',
  `deleted` tinyint NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\",\"required\":false,\"format\":\"int\"}',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `deleted`(`deleted`) USING BTREE,
...
CREATE TABLE `universal_dictionary`  (
  ...
  `mode` int NULL DEFAULT 0 COMMENT '{\"format\":\"int\",\"required\":false}',
...
CREATE TABLE `universal_fragment`  (
  ...
  `mode` tinyint NULL DEFAULT 0 COMMENT '{\"format\":\"int\"}',
...
CREATE TABLE `universal_link`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '{\"mode\":\"auto\"}',
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '{\"type\":\"text\"}',
  `group` int NULL DEFAULT 0 COMMENT '{\"type\":\"select\",\"source\":\"sel_group.*\"}',
...
CREATE TABLE `universal_material`  (
  ...
  `filegroup` tinyint NULL DEFAULT 0,
  `time` datetime NULL DEFAULT NULL,
...
CREATE TABLE `universal_tag`  (
  ...
  `genre` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `associated_count` int NULL DEFAULT 0,
...
CREATE TABLE `universal_tag-map`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '{\"mode\":\"auto\"}',
  `tag_id` int NULL DEFAULT 0,
  `genre` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `associated_id` int NULL DEFAULT 0,
  `status` int NULL DEFAULT 0,
  `deleted` tinyint NULL DEFAULT 0 COMMENT '{\"mode\":\"manual\"}',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `deleted`(`deleted`) USING BTREE,
